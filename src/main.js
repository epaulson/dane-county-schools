  ...
  <div id="aboutModal" class="modal" style="display:none;">
    <div class="modal-content">
      ...
      <h3>Data Sources and Thanks</h3>
        ...
        <ul> 
          <li>Shelley Witte of the Wisconsin Department of Public Instruction who manages the excellent <a href="https://dpi.wi.gov/wise/gis-maps/gis-open-data" target="_blank" rel="noopener">DPI Open Data Portal</a>, which is where much of the district geodata comes from. Shelley also answered many questions as I was starting out on this app.</li> 
          <li>The team at the Wisconsin Department of Public Instruction who maintain the <a href="https://apps6.dpi.wi.gov/SchDirPublic/school-profile" target="_blank" rel="noopener">WI DPI School Directory</a>, which is where I got the NCES IDs for each school and the app links to for each school, providing a much richer set of information than this app presents.</li>
