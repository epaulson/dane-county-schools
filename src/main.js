    ...
    <div class="modal-content">
      ...
      <h3>Data Sources and Thanks</h3>
        ...
        <ul> 
          ...
          <li>The team at the Wisconsin Department of Public Instruction who maintain the <a href="https://apps6.dpi.wi.gov/SchDirPublic/" target="_blank" rel="noopener">WI DPI School Directory</a>, which is where I got the NCES IDs for each school and the app links to for each school, providing a much richer set of information than this app presents.</li>
